	...
	<body>
		...
		<section class="body-sign">
              ...
              @csrf
							...
							<label><b>	Contact Name</b></label>
								<div class="input-group input-group-icon">
									<input name="contact_name"required "type="text" class="form-control input-lg" />
              ...
              <div class="form-group mb-lg">
								...
								<div class="input-group input-group-icon">
									<input name="contact_number" required"type="number" class="form-control input-lg" />
									<span class="input-group-addon">
										<span class="icon icon-lg">
										</span>
									</span>
								...
								<div class="col-sm-5 text-left">
									<button type="submit" class="btn btn-primary hidden-xs">Add Contact</button>
								</div>
							</div>
						</form>
					</div>
